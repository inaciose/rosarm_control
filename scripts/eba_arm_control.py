...
class JointController():
    ...
    def b(self, angle):
        angle = self.check_min_max(cal.BASE_MIN_PWM, cal.BASE_MAX_PWM, angle)
    ...
    def s(self, angle):
        angle = self.check_min_max(cal.SHOULDER_MIN_PWM, cal.SHOULDER_MAX_PWM, angle)
    ...
    def e(self, angle):
        angle = self.check_min_max(cal.ELBOW_MIN_PWM, cal.ELBOW_MAX_PWM, angle)
    ...
    def c(self, angle):
        angle = self.check_min_max(cal.CLAW_MIN_PWM, cal.CLAW_MAX_PWM, angle)
        self.set_joint_state('joint_6', angle)         
        self.set_servo_angle('joint_6', angle)

    #def setJointAngles(self, joint_1, joint_2, joint_3, joint_6):
    ...
    def home(self):
        ...
        #print(self.joint_state, self.robot_joints)
        self.publish_servos_state(self.robot_joints)
    ...
    def off(self):
        ...
        self.s(cal.SHOULDER_HOME_PWM)
        self.e(cal.ELBOW_HOME_PWM)
        self.c(cal.CLAW_HOME_PWM) # remove for 
        self.publish_servos_state(self.robot_joints)
